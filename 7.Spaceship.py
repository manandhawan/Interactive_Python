...
class Ship:
    ...
    def draw(self,canvas):
        thrust_loc = [self.image_center[0]+self.image_size[0],self.image_center[1]]
        if self.thrust:
            canvas.draw_image(ship_image,thrust_loc,self.image_size,self.pos,self.image_size,self.angle)
        else:
    ...
    def inc_angle_vel(self,vel):
        self.angle_vel += vel
        
    def dec_angle_vel(self,vel):
        self.angle_vel -= vel
...
def draw(canvas):
    ...
    canvas.draw_text("Lives: " + str(lives), [100,50], 32, "White")
    canvas.draw_text("Score: " + str(score), [600,50], 32, "White")
...
def rock_spawner():
    ...
    a_rock.vel[0] = random.randrange(0,3)
    a_rock.vel[1] = random.randrange(0,3)
    
    a_rock.pos[0] = random.randrange(0,800)
    a_rock.pos[1] = random.randrange(0,600)
    
    a_rock.ang_vel = random.randrange(0,10)/10
